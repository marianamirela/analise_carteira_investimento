# 1. MODELO DE OTIMIZAÇÃO COM ATIVO LIVRE DE RISCO E VENDA A DESCOBERTO
...
# 2.1. INÍCIO DO MODELO DE ÍNDICE ÚNICO (MIU)
...
# 2.2. REGRESSÃO LINEAR PARA OBTER BETAS, ALFAS E ERROS
